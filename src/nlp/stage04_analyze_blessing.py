...
def _plot_top_tokens(
    ...
    ax.barh(list(reversed(words)), list(reversed(counts)), color="purple")
...
def run_analyze(
    ...
    _plot_top_tokens(
        tokens=tokens,
        top_n=top_n,
        output_path=output_dir / "blessing_top_tokens.png",
    ...
    _plot_wordcloud(
        text=tokens_str,
        output_path=output_dir / "blessing_wordcloud.png",
